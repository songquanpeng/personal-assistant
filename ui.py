...
"font-family: \"Consolas\", \"Microsoft YaHei\";")
        ...
        spacerItem4 = QtWidgets.QSpacerItem(498, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_history.addItem(spacerItem4)
...
""))
        ...
        self.msgClearBtn.setText(_translate("MainWindow", "清空"))
        ...
        self.workTextLineEdit.setPlaceholderText(_translate("MainWindow", "留空则使用随机语句"))
        self.label_15.setText(_translate("MainWindow", "提醒开始休息文案："))
        self.restTextLineEdit.setPlaceholderText(_translate("MainWindow", "留空则使用随机语句"))
